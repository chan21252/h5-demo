...
function Handwriting(id) {
  ...
  var _this = this;
  this.canvas.addEventListener(mouseEvents.down, function (e) {
    _this.downEvent(e)
  }, {passive: false});
  this.canvas.addEventListener(mouseEvents.move, function (e) {
    _this.moveEvent(e)
  }, {passive: false});
  this.canvas.addEventListener(mouseEvents.up, function (e) {
    _this.upEvent(e)
  }, {passive: false});
  this.canvas.addEventListener(mouseEvents.out, function (e) {
    _this.upEvent(e)
  }, {passive: false});
...
Handwriting.prototype.draw = function (e) {
  ...
  var or = 1;
  if (dis > 0) {
    or = Math.min(time / dis * this.linePressure + this.lineMin, this.lineMax) / 2;
  }
  this.radius = or;
  this.upof = of;
